...
class ResNet_v2_block(nn.Module):
    def __init__(self, nfilters, kernel_size=(3, 3), dilation_rate=(1, 1), stride = (1,1), norm_type='BatchNorm', norm_groups=None,
                 ngroups=1, **kwargs):
        super().__init__()
        ...
        self.conv1 = nn.Conv2d(self.nfilters, self.nfilters, kernel_size=self.kernel_size, stride=stride, padding=p,
        ...
        self.conv2 = nn.Conv2d(self.nfilters, self.nfilters, kernel_size=self.kernel_size, stride=stride, padding=p,
...
class FracTALResNet_unit(nn.Module):
    def __init__(self, nfilters, ngroups=1, nheads=1, kernel_size=(3, 3), dilation_rate=(1, 1), stride = (1, 1), norm_type='BatchNorm',
                 norm_groups=None, ftdepth=5, **kwargs):
        super().__init__()

        self.block1 = ResNet_v2_block(nfilters, kernel_size, dilation_rate, stride, norm_type=norm_type,
